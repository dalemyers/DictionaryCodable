...
@Test func testSimpleDecoding() throws {
...
@Test func testOptionalValues() throws {
...
@Test func testNestedDictionaries() throws {
    struct SimpleModel: Codable, Equatable {
        let name: String
        let age: Int
        let isActive: Bool
...
@Test func testComplexArrayDecoding() throws {
    struct SimpleModel: Codable, Equatable {
        let name: String
        let age: Int
        let isActive: Bool
...
@Test func testDirectTypeMatchInSingleValue() throws {
