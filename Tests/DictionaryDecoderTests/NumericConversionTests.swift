...
@Test func testNumericTypes() throws {
    ...
    #expect(result.int32 == 2147483647)
    #expect(result.int64 == 9223372036854775807)
    #expect(result.uint == 100)
    #expect(result.uint8 == 255)
    #expect(result.uint16 == 65535)
    #expect(result.uint32 == 4294967295)
    #expect(result.uint64 == 18446744073709551615)
    #expect(result.double == 3.14159)
    #expect(result.float == Float(2.718))
}

@Test func testNumericConversionsFromNSNumber() throws {
    struct NumericModel: Codable {
        let int8: Int8
        let int16: Int16
        let int32: Int32
    ...
    let dict: [String: Any] = [
        ...
        "int32": NSNumber(value: 100000),
        "int64": NSNumber(value: 10000000),
        "uint": NSNumber(value: 50),
        "uint8": NSNumber(value: 200),
        "uint16": NSNumber(value: 50000),
        "uint32": NSNumber(value: 3000000000),
        "uint64": NSNumber(value: 15000000000),
    ...
    #expect(result.int32 == 100000)
    #expect(result.int64 == 10000000)
    #expect(result.uint == 50)
    #expect(result.uint8 == 200)
    #expect(result.uint16 == 50000)
    #expect(result.uint32 == 3000000000)
    #expect(result.uint64 == 15000000000)
    #expect(result.double == 1.5)
    #expect(result.float == 0.5)
}

@Test func testNumericConversionFromKeyedContainer() throws {
...
@Test func testStringToNumericConversion() throws {
...
@Test func testStringToBoolConversions() throws {
    let decoder = DictionaryDecoder()
...
@Test func testDataFromBase64String() throws {
...
@Test func testDataFromDataBlob() throws {
...
@Test func testURLFromString() throws {
...
@Test func testSingleValueInt8Conversion() throws {
...
@Test func testSingleValueInt16Conversion() throws {
    struct Inner: Codable {
        let value: Int16
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueInt32Conversion() throws {
    struct Inner: Codable {
        let value: Int32
    }
    struct Wrapper: Codable {
    ...
    let decoder = DictionaryDecoder()
    let dict: [String: Any] = ["inner": ["value": NSNumber(value: 100000)]]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.inner.value == 100000)
}

@Test func testSingleValueInt64Conversion() throws {
    struct Inner: Codable {
        let value: Int64
    }
    struct Wrapper: Codable {
    ...
    let decoder = DictionaryDecoder()
    let dict: [String: Any] = ["inner": ["value": NSNumber(value: 9223372036854775807)]]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.inner.value == 9223372036854775807)
}

@Test func testSingleValueUIntConversion() throws {
    struct Inner: Codable {
        let value: UInt
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueUInt8Conversion() throws {
    struct Inner: Codable {
        let value: UInt8
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueUInt16Conversion() throws {
    struct Inner: Codable {
        let value: UInt16
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueUInt32Conversion() throws {
    struct Inner: Codable {
        let value: UInt32
    }
    struct Wrapper: Codable {
    ...
    let decoder = DictionaryDecoder()
    let dict: [String: Any] = ["inner": ["value": NSNumber(value: 4294967295)]]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.inner.value == 4294967295)
}

@Test func testSingleValueUInt64Conversion() throws {
    struct Inner: Codable {
        let value: UInt64
    }
    struct Wrapper: Codable {
    ...
    let decoder = DictionaryDecoder()
    let dict: [String: Any] = ["inner": ["value": NSNumber(value: 18446744073709551615 as UInt64)]]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.inner.value == 18446744073709551615)
}

@Test func testSingleValueDoubleConversion() throws {
    struct Inner: Codable {
        let value: Double
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueFloatConversion() throws {
    struct Inner: Codable {
        let value: Float
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueBoolConversion() throws {
    struct Inner: Codable {
        let value: Bool
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueIntConversion() throws {
    struct Inner: Codable {
        let value: Int
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueNilError() throws {
    struct Inner: Codable {
        let value: String
    }
    struct Wrapper: Codable {
...
@Test func testSingleValueDataFromBase64() throws {
    struct Inner: Codable {
        let data: Data
...
@Test func testSingleValueURLFromString() throws {
    struct Inner: Codable {
        let url: URL
...
@Test func testSingleValueDataDirect() throws {
    struct Inner: Codable {
        let data: Data
    }
    struct Wrapper: Codable {
...
@Test func testKeyedIntConversion() throws {
...
@Test func testKeyedDoubleConversion() throws {
    struct TestModel: Codable {
        let value: Double
...
@Test func testKeyedFloatConversion() throws {
    struct TestModel: Codable {
        let value: Float
...
@Test func testKeyedBoolConversion() throws {
    struct TestModel: Codable {
        let value: Bool
...
@Test func testSingleValueContainerDirectNSNumberInt() throws {
    ...
    struct Wrapper: Decodable {
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Int.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberInt8() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Int8.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberInt16() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Int16.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberInt32() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Int32.self)
            }
        }
    }
    ...
    let decoder = DictionaryDecoder()
    // Use Double NSNumber to force conversion path
    let dict: [String: Any] = ["value": NSNumber(value: 100000.0)]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.value.inner == 100000)
}

@Test func testSingleValueContainerDirectNSNumberInt64() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Int64.self)
            }
        }
    }
    ...
    let decoder = DictionaryDecoder()
    // Use Double NSNumber to force conversion path
    let dict: [String: Any] = ["value": NSNumber(value: 9999999999.0)]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.value.inner == 9999999999)
}

@Test func testSingleValueContainerDirectNSNumberUInt() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(UInt.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberUInt8() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(UInt8.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberUInt16() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(UInt16.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberUInt32() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(UInt32.self)
            }
        }
    }
    ...
    let decoder = DictionaryDecoder()
    // Use Double NSNumber to force conversion path
    let dict: [String: Any] = ["value": NSNumber(value: 3000000000.0)]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.value.inner == 3000000000)
}

@Test func testSingleValueContainerDirectNSNumberUInt64() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(UInt64.self)
            }
        }
    }
    ...
    let decoder = DictionaryDecoder()
    // Use Double NSNumber to force conversion path
    let dict: [String: Any] = ["value": NSNumber(value: 15000000000.0)]
    let result = try decoder.decode(Wrapper.self, from: dict)
    #expect(result.value.inner == 15000000000)
}

@Test func testSingleValueContainerDirectNSNumberDouble() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Double.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberFloat() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Float.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectNSNumberBool() throws {
    struct Wrapper: Decodable {
        let value: CustomDecodable
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Bool.self)
            }
        }
    }
...
@Test func testSingleValueContainerDirectData() throws {
    ...
    struct Wrapper: Decodable {
        ...
        struct CustomDecodable: Decodable {
            ...
            init(from decoder: Decoder) throws {
                let container = try decoder.singleValueContainer()
                self.inner = try container.decode(Data.self)
            }
        }
    }
...
@Test func testKeyedContainerNSNumberToIntConversion() throws {
    ...
    let nsNumber: NSNumber = NSNumber(value: 42.9 as Double)
...
@Test func testKeyedContainerNSNumberToFloatConversion() throws {
    ...
    let decoder = DictionaryDecoder()
    let nsNumber: NSNumber = NSNumber(value: 2.5 as Double)
    let dict: [String: Any] = ["value": nsNumber as Any]
...
@Test func testKeyedContainerNSNumberToBoolConversion() throws {
    ...
    let decoder = DictionaryDecoder()
    let nsNumber: NSNumber = NSNumber(value: 1 as Int)
    let dict: [String: Any] = ["value": nsNumber as Any]
...
@Test func testKeyedContainerNSNumberInt64ToFloatConversion() throws {
    ...
    let decoder = DictionaryDecoder()
    let nsNumber: NSNumber = NSNumber(value: 12345 as Int64)
    let dict: [String: Any] = ["value": nsNumber as Any]
...
@Test func testKeyedContainerNSNumberDoubleToFloatConversion() throws {
    ...
    let decoder = DictionaryDecoder()
    let nsNumber: NSNumber = NSNumber(value: 3.14159 as Double)
    let dict: [String: Any] = ["value": nsNumber as Any]
...
@Test func testKeyedContainerNSNumberUIntToBoolConversion() throws {
    ...
    let decoder = DictionaryDecoder()
    let nsNumber: NSNumber = NSNumber(value: 5 as UInt)
    let dict: [String: Any] = ["value": nsNumber as Any]
...
@Test func testSingleValueDirectTypeMatch() throws {
...
@Test func testSingleValueStringToStringConversion() throws {
...
@Test func testSuperDecoderForKeyReturnsEmptyDictWhenMissing() throws {
